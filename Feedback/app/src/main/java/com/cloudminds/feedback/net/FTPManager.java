...
public class FTPManager {
    ...
    final static int FTP_CONNECT_TIMEOUT = 60 * 1000;  //unit by millisecond
    final static int FTP_DATA_TIMEOUT = 90 * 1000;  //unit by millisecond
    ...
    public synchronized boolean openFTP() throws Exception {
        ...
        ftpClient.connect(ComDef.FTP_SERVER_URL, ComDef.FTP_SERVER_PORT);
        ...
        if (FTPReply.isPositiveCompletion(replyCode)) {
            ...
            if (ftpClient.login(ComDef.FTP_USERNAME, ComDef.FTP_PASSWORD)) {
                result = true;
