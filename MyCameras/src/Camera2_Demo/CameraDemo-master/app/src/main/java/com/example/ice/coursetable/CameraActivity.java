...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        iv_thumb.setOnClickListener(v -> {
            Toast.makeText(CameraActivity.this, mPicFilePath, Toast.LENGTH_LONG).show();

            //###@: android.os.FileUriExposedException: file:///storage/emulated/0/DCIM/temp.jpg exposed beyond app through Intent.getData()
...
//                mSurfaceView.setVisibility(View.INVISIBLE);
    ...
    private String genPicFilePath() {
        String fileName = "Camera2Demo_" + System.currentTimeMillis() + ".jpg";
        mPicFilePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM) + "/Camera/" + fileName;
        return mPicFilePath;
    }

    private void writeToFile(Bitmap bitmap) {
        File file = new File(genPicFilePath());
        try {
