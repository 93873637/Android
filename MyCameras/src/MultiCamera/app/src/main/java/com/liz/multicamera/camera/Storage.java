...
import com.liz.androidutils.ApiHelper;
...
public class Storage {
    ...
    public static final long LOW_STORAGE_THRESHOLD_BYTES = 128 * 1024 * 1024;
    ...
    public static int writeFile(String path, byte[] jpeg, ExifInterface exif, String mimeType) {
        Log.e(TAG, "SnapdragonCamera:Storage: path=" + path);

        if (exif != null && (mimeType == null ||
            mimeType.equalsIgnoreCase("jpeg"))) {
            Log.i(TAG, "SnapdragonCamera:Storage: writeExif");
            try {
            ...
            Log.i(TAG, "SnapdragonCamera:Storage: jpeg != null");
            ...
            Log.e(TAG, "SnapdragonCamera:Storage: jpeg null");
        }
        return 0;
    }

    public static void writeFile(String path, byte[] data) {
        Log.e(TAG, "SnapdragonCamera:Storage:writeFile: path=" + path);
    ...
    public static Uri addImage(ContentResolver resolver, String title, long date,
        ...
        //new Exception("SnapdragonCamera:Storage222").printStackTrace();

        String path = generateFilepath(title, mimeType);
        Log.e(TAG, "Storage:addImage: path=" + path);
    ...
    public static void updateImage(Uri imageUri, ContentResolver resolver, String title, long date,
            Location location, int orientation, ExifInterface exif, byte[] jpeg, int width,
            int height, String mimeType) {
        //new Exception("Storage333").printStackTrace();
        String path = generateFilepath(title, mimeType);
    ...
    public static void updateImage(Uri imageUri, ContentResolver resolver, String title,
        ...
        //new Exception("Storage444").printStackTrace();
        ContentValues values =
                getContentValuesForData(title, date, location, orientation, jpegLength, path,
                        width, height, mimeType);
