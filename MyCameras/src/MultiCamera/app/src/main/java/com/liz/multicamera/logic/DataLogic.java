...
import com.liz.multicamera.camera.CameraManagerFactory;
import com.liz.multicamera.camera.CameraSettings;
import com.liz.multicamera.camera.Exif;
import com.liz.multicamera.camera.SensorControler;
import com.liz.multicamera.camera.Storage;
import com.liz.multicamera.exif.ExifInterface;
...
import static com.liz.multicamera.camera.CameraSettings.KEY_AUTO_ISO;
import static com.liz.multicamera.exif.ExifInterface.TAG_IMAGE_LENGTH;
import static com.liz.multicamera.exif.ExifInterface.TAG_IMAGE_WIDTH;
...
public class DataLogic extends ComDef {
    ...
    public static void startPreview() {
        ...
        try {
            ...
            mSurfaceHolder.setFixedSize(ComDef.SURFACE_SIZE_WIDTH, ComDef.SURFACE_SIZE_HEIGHT);
...
//                + ", shouldbe: currentISO=" + NightMode.getCurrentISO() + ", currentExpTime=" + NightMode.getCurrentExposureTime());
    ...
    public static String getCameraInfo() {
        ...
        try {
            final String isoValue = ParametersWrapper.getISOValue(parameters);
            ...
            LogUtils.te2("get camera parameter failed, ex = " + e.toString());
        }
...
////        return focus(callback);
    ...
    public static String saveImage(byte[] jpegData) {
        ...
        LogUtils.d("Storage.saveImage: get exif=" + exif.toString() + ", size=" + exif.getTagIntValue(TAG_IMAGE_WIDTH) + "x" + exif.getTagIntValue(TAG_IMAGE_LENGTH));
