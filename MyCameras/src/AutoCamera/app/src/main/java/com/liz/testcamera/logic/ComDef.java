...
public class ComDef {
    ...
    public static final int CAMERA_ID_BACK_MAIN = 0;   //see from top of cloudia box, the left one is back main
    public static final int CAMERA_ID_BACK_SUB = 1;    //see from top of cloudia box, the right one is back sub
    public static final int CAMERA_ID_FRONT_MAIN = 2;  //on cloudia box, same as back sub, but not apply MountAngle?
    public static final int CAMERA_ID_FRONT_SUB = 3;   //open failed for cloudia box
    public static final int CAMERA_ID_DEFAULT = CAMERA_ID_BACK_SUB;
    ...
    public static final int SURFACE_SIZE_WIDTH = 1600/2;
    public static final int SURFACE_SIZE_HEIGHT = 900/2;
