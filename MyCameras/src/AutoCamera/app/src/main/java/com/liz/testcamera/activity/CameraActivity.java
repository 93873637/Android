...
//    }
            ...
            public void run () {
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        mSurfaceHeight += 100;
                        mSurfaceWidth += 100;
                        mSurfaceHeight %= ComDef.SURFACE_SIZE_HEIGHT;
                        mSurfaceWidth %= ComDef.SURFACE_SIZE_WIDTH;
                        mSurfaceView.resize(mSurfaceHeight, mSurfaceWidth);
                    }
                });
            }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        //###@: mSurfaceView.adjustSizeForPreview(ComDef.SURFACE_SIZE_WIDTH, ComDef.SURFACE_SIZE_HEIGHT);
