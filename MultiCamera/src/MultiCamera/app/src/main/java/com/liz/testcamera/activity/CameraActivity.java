...
import com.liz.testcamera.album.AlbumHelper;
import com.liz.testcamera.album.ImageItem;
import com.liz.testcamera.app.ThisApp;
import com.liz.testcamera.camera.CameraManager;
import com.liz.testcamera.logic.ComDef;
import com.liz.testcamera.logic.DataLogic;
import com.liz.testcamera.ui.ResizableSurfaceView;
import com.liz.testcamera.ui.ShutterButton;
import com.liz.testcamera.utils.BitmapUtils;
            ...
            public void onPictureTaken(final byte[] jpegData, final CameraManager.CameraProxy camera, final String saveFileName) {
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        if (shot_count == 0) {
                            shot_count = 1;
                            DataLogic.mCameraLensId = ComDef.CAMERA_ID_FRONT_MAIN;
...
//                            shot_count = 2;
//                            DataLogic.mCameraLensId = ComDef.CAMERA_ID_BACK_SUB;
//                            new Handler().postDelayed(new Runnable() {
//                                public void run() {
//                                    DataLogic.stopPreview();
//                                    DataLogic.closeCamera();
...
//                            shot_count = 3;
//                            DataLogic.mCameraLensId = ComDef.CAMERA_ID_FRONT_SUB;
//                            new Handler().postDelayed(new Runnable() {
//                                public void run() {
//                                    DataLogic.stopPreview();
//                                    DataLogic.closeCamera();
...
//    }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        mSurfaceView.adjustSizeForPreview(ComDef.PREVIEW_SIZE_WIDTH, ComDef.PREVIEW_SIZE_HEIGHT);
    }
