...
public class NumUtils {
    ...
    public static String zeroPadding(int v, int n) {
        return zeroPadding((long)v, n);
    }

    public static String zeroPadding(long v, int n) {
        String vs = "" + v;
    ...
    public static void test_formatShow() {
        JLog.newLine();
        JLog.trace();
        AssertUtils.assertEquals("com.liz.androidutils.NumUtils.formatShow(123)", "123");
        AssertUtils.assertEquals("com.liz.androidutils.NumUtils.formatShow(1234)", "1,234");
    }

    public static void test_unsigned() {
    ...
    public static void test_bytes2ShortB() {
    ...
    public static void test_printBytes() {
        byte[] bi = int2Bytes(-1);
        printBytes(bi);
