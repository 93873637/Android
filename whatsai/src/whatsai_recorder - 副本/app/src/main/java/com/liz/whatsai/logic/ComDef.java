...
public class ComDef {
    ...
    //public static final String WHATSAI_RECORDER_HOME = Environment.getExternalStorageDirectory().getAbsolutePath() + "/0.sd/whatsai/recorder";
    public static final String WHATSAI_RECORDER_HOME = "/sdcard/0.sd/whatsai/recorder";
